...
//		Delete some Inmates, Employees and Others
		...
		involve.deleteOther("Will", "Lyan");
		
//		Add some Inmates, Employees and Others
		involve.addInmateByName("BOBBY", "MARTYN", "Participant", "1", false);
		involve.addEmployee("Pen", "Test", "Other", "0", true);
		involve.addOthers("Ray", "Penber", "Volunteer", "Participant", "0", false);
		
		involve.clickUpdate();
		
//		Verify the deleted Inmate, Employee & Others
		summary.verifyInmateByNameNotInvolved("JOHN", "SMITH", "Witness");
		
		summary.verifyEmployeeNotInvolved("Mark", "Belleza", "Other");
		
		summary.verifyOtherNotInvolved("Will", "Lyan", "Participant");
		
//		Verify the Inmates, Employee & Others that were added and the ones that was not deleted
		summary.verifyInmateByNameInInvolved("WILLIAM", "BEST", "Other");
		summary.verifyInmateByNameInInvolved("BOBBY", "MARTYN", "Participant");
		
		summary.verifyEmployeeInInvolved("Derek", "Dao", "Witness");
		summary.verifyEmployeeInInvolved("Pen", "Test", "Other");
		
		summary.verifyOtherInInvolved("Jason", "Smith", "Other");
		summary.verifyOtherInInvolved("Ray", "Penber", "Participant");
	}
}
