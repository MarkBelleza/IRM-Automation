...
//		Set user to Regional Office and Northern Regional Office
...
//		Fill in the appropriate fields in Notification (set location to NOT within the user location, Brockville)
...
//		Fill in the appropriate fields in Notification (set location to within the user location, Brockville)
		notificationFields.selectPriority("One");
		notificationFields.selectLocation("BROCKVILLE JAIL - ADULT (Institution)");
		notificationFields.selectArea("Washroom");
		notificationFields.clickNext();
