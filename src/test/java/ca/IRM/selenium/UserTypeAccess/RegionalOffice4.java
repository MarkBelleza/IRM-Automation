...
//		Set user to Staff Sergeant and BROCKVILLE
...
//		Change user type and location to Regional Office and Northern (Brock is outside Northern Regional Office)
...
//		In summary view, only the IIR should be visible
...
//		Verify the changes are visible
		...
		sum.verifyIncidentTypesNotVisible("(P1) Serious Inmate on Inmate");
		sum.verifyIncidentTypesNotVisible("Item thrown/contact");
		sum.verifyIncidentTypesNotVisible("Bodily substance");
